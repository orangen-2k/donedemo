@extends('user.user') @section('title', "Đổi thông tin") @section('content-user')
    <div style="margin: 0 auto; width: 50%;">
        ...
        @endif
        <form action="{{route('change.passport',['id'=>$User])}}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{csrf_token()}}" />
            <div class="form-group m-form__group row">
                <label class="col-xl-3 col-lg-3 col-form-label"><span
                        class="text-danger">*</span> Kiểm tra mật khẩu: </label>
                <div class="col-xl-9 col-lg-9">
                    <input type="password" name="Password-now" class="form-control m-input name-field"
                           placeholder="Điền mật khẩu hiện tại" />
                </div>
            </div>
            <div class="form-group m-form__group row">
                <label class="col-xl-3 col-lg-3 col-form-label"><span
                        class="text-danger">*</span> Mật khẩu mới: </label>
                <div class="col-xl-9 col-lg-9">
                    <input type="password" name="Passwordnew" class="form-control m-input name-field"
                           placeholder="Điền mật khẩu mới" />
                </div>
            </div>
            <div class="form-group m-form__group row">
                <label class="col-xl-3 col-lg-3 col-form-label"><span
                        class="text-danger">*</span> Nhập lại mật khẩu mới: </label>
                <div class="col-xl-9 col-lg-9">
                    <input type="password" name="Passwordnew-again" class="form-control m-input name-field"
