@extends('user.user') @section('content-user') @section('title','Danh sách các tin quan tâm nhất')
<div class="container">
    <div class="row">
                    ...
                    <div class="entry-summary">
                        <div class="container">
                            <div class="wrap-title">
                                <h1>Danh sách các tin hay nhất</h1>
                            </div>
                        </div>
                                                            ...
                                                            <div class="content-top-in">
                                                                <div class="entry-meta clearfix">
                                                                    <div class="meta-entry entry-date pull-left">
                                                                        <i class="fa fa-calendar"></i>Ngày đăng: {{$item->soluotxem}}
